...
export default function EditModalUnstyled({
  ...
  const updateFunc =  () => {
    updateAdmin({updateData:info},userId);
      handleClose();
  };
  ...
  return (
    <Box>
      <Modal
        sx={{ minWidth: "300px", width: "90%", margin: "auto" }}
...
<Box sx={{display:"flex", alignItems:"center", gap:"0.5rem"}}>
  <Typography sx={{fontWeight:"700",  minWidth:"140px"}}>Authorization:</Typography>
  <FormControl sx={{width:"60%"}}>

  <NativeSelect
    defaultValue={info.authorization}
    inputProps={{
      id: 'uncontrolled-native',
    }}
    onChange={(e)=>setInfo({...info, authorization:e.target.value})}
  >
...
<Box sx={{display:"flex", alignItems:"center", gap:"0.5rem"}}>
  <Typography sx={{fontWeight:"700",  minWidth:"140px"}}>Verified:</Typography>
  <FormControl sx={{width:"60%"}}>
  ...
  <NativeSelect
    ...
    onChange={(e)=>setInfo({...info, verified:e.target.value})}
  >
    <option value={Boolean(true)}>Yes</option>
    <option value={Boolean(false)}>No</option>
  </NativeSelect>
...
<Box sx={{display:"flex", alignItems:"center", gap:"0.5rem"}}>
  <Typography sx={{fontWeight:"700",  minWidth:"140px"}}>Owner:</Typography>
  <FormControl sx={{width:"60%"}}>

  <NativeSelect
    defaultValue={info.owner}
    inputProps={{
      id: 'uncontrolled-native',
    }}
